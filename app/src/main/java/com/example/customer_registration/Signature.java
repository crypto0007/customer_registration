...
public class Signature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backarrowsignj = findViewById(R.id.backarrowsign);

        backarrowsignj.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    finish();
                    Intent in = new Intent(Signature.this,ServiceCompletion.class);
...
//        });
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            ...
            scanMediaFile(photo);
            filepath =  String.format("Signature_%d.jpg", System.currentTimeMillis());
            Log.d(TAG, (filepath));
            result = true;
        } catch (IOException e) {
            e.printStackTrace();
