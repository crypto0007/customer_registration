...
public class Termsandconditions extends AppCompatActivity {
    ...
    ImageView backarrowwebviewtacj;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_termsandconditions);
        backarrowwebviewtacj = findViewById(R.id.backarrowwebviewtac);
    ...
    private void back(){
        backarrowwebviewtacj.setOnClickListener(new View.OnClickListener() {
            @Override
...
//            }
    ...
    private void webview(){
        ...
        webView.loadUrl("https://policies.google.com/terms?hl=en-IN&fg=1");
    }
}